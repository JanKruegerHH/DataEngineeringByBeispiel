...
wop = np.array([0.8333, 0.6165, 0.4400])
weights = np.array([0.5, 0.375, 0.125])
lower = np.array([0.50, 0.50, 0.50])
...
# ── Print Results ──────────────────────────────────────────────────────────────
logger.info(f"{'Station':<12} {'Weight':>8} {'WOP':>6} {'Lower':>7} {'Upper':>7} {'JAC':>10} {'Proposal':>10}")
logger.info("-" * 66)
